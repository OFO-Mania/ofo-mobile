    ...
    return (
        <>
            ...
            <ScrollView style={stylesHome.container}>
                ...
                />
                <View style={stylesHome.separator} />
                <Text style={stylesHome.titleBottomSection}>Interesting In OFO</Text>
                <Text style={stylesHome.descriptionBottomSection}>Don't claim to update if you haven't tried this feature yet</Text>
